    ...
    <div className="container">
      ...
      <div className="box">
        ...
        <div className="detail-box">
          ...
          <div className="btn-box">
            <a href="index.js">Register Now</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="row">
        ...
        <div className="col-md-3">
          <div className="info_links">
            ...
            <ul>
              <li>
                <a href="index.js">There are many</a>
              </li>
              <li>
                <a href="index.js">variations of</a>
              </li>
              <li>
                <a href="index.js">passages of</a>
              </li>
              <li>
                <a href="index.js">Lorem Ipsum</a>
              </li>
              <li>
                <a href="index.js">available, but the</a>
              </li>
              <li>
                <a href="index.js">majority have</a>
              </li>
              <li>
                <a href="index.js">suffered</a>
              </li>
            </ul>
          </div>
        </div>
